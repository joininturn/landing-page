...
export default function MeetTheTeam() {
    return (
        <section id="team" className="flex flex-col mt-16 w-[90%] max-w-[1200px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-x-5 mx-auto mt-10">
                { /* shuddup bryce, ik this can be a component */ }
                <div className="flex flex-col w-70 h-50 bg-blue-400 rounded-xl shadow-xl">
                ...
                <div className="flex flex-col w-70 h-50 bg-green-400 rounded-xl shadow-xl">
                    <div className="m-1 bg-white rounded-lg h-full drop-shadow-xl">
                        <div className="card-content flex flex-col px-10 pt-3 gap-y-3">
                ...
                <div className="flex flex-col w-70 h-50 bg-red-400 rounded-xl shadow-xl">
                    <div className="m-1 bg-white rounded-lg h-full drop-shadow-xl">
                        <div className="card-content flex flex-col px-10 pt-3 gap-y-3">
                ...
                <div className="flex flex-col w-70 h-50 bg-yellow-300 rounded-xl shadow-xl">
                    <div className="m-1 bg-white rounded-lg h-full drop-shadow-xl">
                        <div className="card-content flex flex-col px-10 pt-3 gap-y-3">
